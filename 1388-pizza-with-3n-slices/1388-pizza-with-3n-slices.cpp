...
//      }
    ...
    int maxSizeSlices(vector<int>& slices) {
       ...
       // int k=slices.size();
//      int case1=solve(0,k-2,slices,k/3);    //0 se leke k/3 tak slices kahunga
//     int case2=solve(1,k-1,slices,k/3);     // se leke k/3 tak slices kahunga means 1st slice skipped
